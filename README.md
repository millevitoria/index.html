...
<body>
    ...
    <main class="container my-5">
        ...
        <section id="eletronica" class="my-5 pt-6 secao-eletronica">
            <div class="container d-flex align-items-center ">
                <div class="col-4 d-flex justify-content-center">
                    <img src="img/image (1).png" class="rounded-pill" alt="" width="273" height="331" loading="lazy">
                </div>
                <div class="col-5">
                    <h2>O que foi a musica eletronica?</h2>
                    <p class="p-2">A música eletrónica nasceu da manipulação de sons por meio de equipamentos eletrónicos,
                         tendo suas origens no século XX com a música concreta francesa e a Elektronische Musik alemã, 
                         surgidas após a Segunda Guerra Mundial. Desenvolvida com sintetizadores, samplers e computadores,
                          tornou-se um gênero musical global, popularizado a partir da década de 1970 e se consolidou com
                           gêneros como house, techno e trance. </p>
                </div>
            </div>
        </section>
    ...
    <footer class="text-center p-3 fst-italic">
        ...
        <p class="mt-3">Desenvolvido por kamille </p>
    </footer>
